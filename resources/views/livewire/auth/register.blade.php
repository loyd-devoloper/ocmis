<div >
    ...
    <div class="py-20">
        <form wire:submit="register" class="bg-white card max-w-xl mx-auto p-5">
            <h2 class=" text-2xl font-medium pb-2"> Sign Up</h2>
             ...
             <p class="text-center pt-8">Have an account? <a href="{{ route('login') }}"class="link link-primary link-hover">Sign In</a></p>
         </form>
    </div>
</div>
